...
bool Figura_L_Odwrocona::Auto_Down_0 ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_L_Odwrocona::Auto_Down_1 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[2].y + 1) < 16 )
	{
...
bool Figura_L_Odwrocona::Auto_Down_2 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[1].y + 1) < 16 )
	{
...
bool Figura_L_Odwrocona::Auto_Down_3 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[0].y + 1) < 16 )
	{
...
bool Figura_L_Odwrocona::MoveDown ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_L_Odwrocona::Change_Position ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_L_Odwrocona::Move_0 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
...
bool Figura_L_Odwrocona::Move_1 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
		if( Figura[1].y + 1 < 16 )
		{
			...
			if( !Map[ (Figura[3].y + 1) ][ Figura[3].x ].Draw && !Map[ (Figura[2].y + 1) ][ Figura[2].x ].Draw &&
				!Map[ (Figura[1].y + 1) ][ Figura[1].x ].Draw )
			{
				//std::cout << "Figura_Kwadrat::Move3333333333333333333333" << std::endl ;
				for(int i = 0 ; i < 4 ; i++)
				{
...
bool Figura_L_Odwrocona::Move_2 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
...
bool Figura_L_Odwrocona::Move_3 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
...
bool Figura_L_Odwrocona::Move ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map )
{
...
void Figura_L_Odwrocona::DrawBlock ()
{
	for(int i = 0 ; i < 4 ; i++)
	{
		if( Figura[i].y > 0 )
...
void Figura_L_Odwrocona::DrawNext ()
{
	switch(Position)
	{
...
bool Figura_L_Odwrocona::Colision ( const std::vector< std::array<DataMap,10> > & Map )
{
...
const std::vector< DataBlock > Figura_L_Odwrocona::ReturnDataBlock ()
{
	return Figura ;
}
