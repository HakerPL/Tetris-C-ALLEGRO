...
bool Figura_Zawijak_Lewy::Auto_Down_0 ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_Zawijak_Lewy::Auto_Down_1 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[0].y + 1) < 16 )
	{
...
bool Figura_Zawijak_Lewy::MoveDown ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_Zawijak_Lewy::Change_Position ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_Zawijak_Lewy::Move_0 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
...
bool Figura_Zawijak_Lewy::Move_1 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
...
bool Figura_Zawijak_Lewy::Move ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map )
{
...
void Figura_Zawijak_Lewy::DrawBlock ()
{
	for(int i = 0 ; i < 4 ; i++)
	{
		if( Figura[i].y > 0 )
...
void Figura_Zawijak_Lewy::DrawNext ()
{
	switch(Position)
	{
...
bool Figura_Zawijak_Lewy::Colision ( const std::vector< std::array<DataMap,10> > & Map )
{
	if( Figura[0].y == 15 )
		return true ;
...
const std::vector< DataBlock > Figura_Zawijak_Lewy::ReturnDataBlock ()
{
	return Figura ;
}
