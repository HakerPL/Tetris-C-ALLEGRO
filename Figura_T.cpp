...
bool Figura_T::Auto_Down_0 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[4].y + 1) < 16 )
	{
		//SPRAWDZAMY CZE POLE JEST PUSTE
		if( !Map[ (Figura[0].y + 1) ][ Figura[0].x ].Draw && !Map[ (Figura[4].y + 1) ][ Figura[4].x ].Draw &&
...
bool Figura_T::Auto_Down_1 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[2].y + 1) < 16 )
	{
		//SPRAWDZAMY CZE POLE JEST PUSTE
		if( !Map[ (Figura[4].y + 1) ][ Figura[4].x ].Draw && !Map[ (Figura[3].y + 1) ][ Figura[3].x ].Draw && !Map[ (Figura[2].y + 1) ][ Figura[2].x ].Draw )
		{
			for(int i = 0 ; i < 5 ; i++)
			{
				//std::cout << "Figura[" << i << "].y = " << Figura[i].y << std::endl ;
...
bool Figura_T::Auto_Down_2 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[1].y + 1) < 16 )
	{
...
bool Figura_T::Auto_Down_3 ( const std::vector< std::array<DataMap,10> > & Map )
{
	//JESLI POZYCJA FIGURY + 1 JEST MNIEJSZE OD 16 (15 OSTATNI ELEMENT)
	if( (Figura[2].y + 1) < 16 )
	{
		//SPRAWDZAMY CZE POLE JEST PUSTE
		if( !Map[ (Figura[4].y + 1) ][ Figura[4].x ].Draw && !Map[ (Figura[3].y + 1) ][ Figura[3].x ].Draw && 
			!Map[ (Figura[2].y + 1) ][ Figura[2].x ].Draw )
		{
			for(int i = 0 ; i < 5 ; i++)
			{
...
bool Figura_T::MoveDown ( const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_T::Change_Position ( const std::vector< std::array<DataMap,10> > & Map )
{
	...
	switch(check_pos)
	{
		case 0:
			...
			if( Figura[3].y - 1 >= 0 )
			{
				if( !Map[ Figura[3].y + 1 ][ Figura[3].x ].Draw && !Map[ Figura[3].y - 1 ][ Figura[3].x ].Draw &&
					!Map[ Figura[3].y - 1 ][ Figura[3].x - 1 ].Draw )
				{
					Figura[0].x = Figura[3].x - 1 ;
					Figura[0].y = Figura[3].y - 1 ;
					Figura[1].x = Figura[3].x     ;
					Figura[1].y = Figura[3].y - 1 ;
					Figura[2].x = Figura[3].x + 1 ;
					Figura[2].y = Figura[3].y - 1 ;
					Figura[4].x = Figura[3].x     ;
					Figura[4].y = Figura[3].y + 1 ;
					Position = 0 ;
					return true ;
				}
			}
		...
		case 1:
			...
			if( !Map[ Figura[3].y ][ Figura[3].x + 1 ].Draw && !Map[ Figura[3].y + 1 ][ Figura[3].x - 1 ].Draw &&
				!Map[ Figura[3].y ][ Figura[3].x - 1 ].Draw )
			{
				Figura[1].x = Figura[3].x - 1 ;
				Figura[1].y = Figura[3].y     ;
				Figura[2].x = Figura[3].x - 1 ;
				Figura[2].y = Figura[3].y + 1 ;
				Figura[4].x = Figura[3].x + 1 ;
				Figura[4].y = Figura[3].y     ;
				Position = 1 ;
				return true ;
			}
			break ;
		...
		case 3:
			...
			if( Figura[3].y - 1 >= 0 )
			{
				if( !Map[ Figura[3].y - 1 ][ Figura[3].x + 1 ].Draw && !Map[ Figura[3].y ][ Figura[3].x + 1 ].Draw &&
					!Map[ Figura[3].y ][ Figura[3].x - 1 ].Draw )
				{
					Figura[0].x = Figura[3].x + 1 ;
					Figura[0].y = Figura[3].y - 1 ;
...
bool Figura_T::Move_0 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
		...
		if( Figura[0].x - 1 >= 0 )
		{
			if( Figura[3].y - 1 >= 0 )
			{
				if( !Map[ Figura[0].y ][ Figura[0].x - 1 ].Draw && !Map[ Figura[3].y ][ Figura[3].x - 1 ].Draw &&
					!Map[ Figura[4].y ][ Figura[4].x - 1 ].Draw )
				{
					for(int i = 0 ; i < 5 ; i++)
...
bool Figura_T::Move_1 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
		if( Figura[2].y + 1 < 16 )
		{
			...
			if( !Map[ (Figura[3].y + 1) ][ Figura[3].x ].Draw && !Map[ (Figura[2].y + 1) ][ Figura[2].x ].Draw &&
				!Map[ (Figura[4].y + 1) ][ Figura[4].x ].Draw )
			{
				//std::cout << "Figura_Kwadrat::Move3333333333333333333333" << std::endl ;
				for(int i = 0 ; i < 5 ; i++)
				{
		...
		if( Figura[4].x + 1 < 10 )
		{
			if( Figura[0].y >= 0 )
			{
				if( !Map[ Figura[0].y ][ Figura[0].x + 1 ].Draw &&
					!Map[ Figura[2].y ][ Figura[2].x + 1 ].Draw && !Map[ Figura[4].y ][ Figura[4].x + 1 ].Draw )
				{
					for(int i = 0 ; i < 5 ; i++)
						Figura[i].x = Figura[i].x + 1 ;
					return true ;
			...
			{
				if( !Map[ Figura[2].y ][ Figura[2].x + 1 ].Draw && !Map[ Figura[4].y ][ Figura[4].x + 1 ].Draw )
				{
					for(int i = 0 ; i < 5 ; i++)
						Figura[i].x = Figura[i].x + 1 ;
					return true ;
...
bool Figura_T::Move_2 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
	...
	else if( al_key_down(&keyState , ALLEGRO_KEY_RIGHT) )
	{
		if( Figura[2].x + 1 < 10 )
		{
			if( Figura[4].y >= 0 )
			{
				if( !Map[ Figura[4].y ][ Figura[4].x + 1 ].Draw && !Map[ Figura[3].y ][ Figura[3].x + 1 ].Draw && 
					!Map[ Figura[2].y ][ Figura[2].x + 1 ].Draw ) 
				{
					for(int i = 0 ; i < 5 ; i++)
						Figura[i].x = Figura[i].x + 1 ;
...
bool Figura_T::Move_3 ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map ) 
{
	if( al_key_down(&keyState , ALLEGRO_KEY_DOWN) )
	{
		//std::cout << "Figura_Kwadrat::Move" << std::endl ;
	...
	else if( al_key_down(&keyState , ALLEGRO_KEY_LEFT) )
	{
		...
		if( Figura[4].x - 1 >= 0 )
		{
			if( Figura[0].y >= 0 )
			{
				if( !Map[ Figura[0].y ][ Figura[0].x - 1 ].Draw && !Map[ Figura[4].y ][ Figura[4].x - 1].Draw &&
					!Map[ Figura[2].y ][ Figura[2].x - 1 ].Draw )
				{
					for(int i = 0 ; i < 5 ; i++)
						Figura[i].x = Figura[i].x - 1 ;
			...
			{
				if( !Map[ Figura[4].y ][ Figura[4].x - 1 ].Draw &&
					!Map[ Figura[2].y ][ Figura[2].x - 1 ].Draw )
				{
					for(int i = 0 ; i < 5 ; i++)
						Figura[i].x = Figura[i].x - 1 ;
	...
	else if( al_key_down(&keyState , ALLEGRO_KEY_RIGHT) )
	{
		...
		if( Figura[1].x + 1 < 10 )
		{
			...
			{
				if( !Map[ Figura[1].y ][ Figura[1].x + 1 ].Draw &&
					!Map[ Figura[2].y ][ Figura[2].x + 1 ].Draw && !Map[ Figura[0].y ][ Figura[0].x + 1 ].Draw )
				{
					for(int i = 0 ; i < 5 ; i++)
						Figura[i].x = Figura[i].x + 1 ;
					return true ;
...
bool Figura_T::Move ( ALLEGRO_KEYBOARD_STATE &keyState , const std::vector< std::array<DataMap,10> > & Map )
{
...
bool Figura_T::Colision ( const std::vector< std::array<DataMap,10> > & Map )
{
	...
	switch(Position)
	{
		case 0:
			...
			if( Figura[4].y == 15 || Map[ Figura[0].y + 1 ][ Figura[0].x ].Draw || Map[ Figura[4].y + 1 ][ Figura[4].x ].Draw ||
				Map[ Figura[2].y + 1 ][ Figura[2].x ].Draw )
				return true ;
			break ;
		...
		case 3:
			...
			if( Figura[2].y == 15 || Map[ Figura[4].y + 1 ][ Figura[4].x ].Draw || Map[ Figura[2].y + 1 ][ Figura[2].x ].Draw ||
...
const std::vector< DataBlock > Figura_T::ReturnDataBlock ()
{
	return Figura ;
}
